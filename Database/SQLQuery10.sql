...
CREATE OR ALTER PROCEDURE dbo.sp_DangNhapNguoiDung
...
CREATE OR ALTER PROCEDURE dbo.sp_KhachHang_Update
...
-- 7) Thêm hợp đồng
CREATE OR ALTER PROCEDURE dbo.sp_ThemHopDong
...
-- 8) Thêm đơn hàng
CREATE OR ALTER PROCEDURE dbo.sp_ThemDonHang
...
CREATE OR ALTER PROCEDURE dbo.sp_ThemViTriLayMau
    @ViTriID NVARCHAR(50),
    @DonHangID NVARCHAR(50),
    @MaViTri NVARCHAR(50) = NULL,
...
CREATE OR ALTER PROCEDURE dbo.sp_ThemThongSoMoiTruong
...
-- 11) Thêm tập kết quả
CREATE OR ALTER PROCEDURE dbo.sp_ThemTapKetQua
...
-- 12) Thêm thông báo
CREATE OR ALTER PROCEDURE dbo.sp_ThemThongBao
...
-- 13) Ghi nhật ký
CREATE OR ALTER PROCEDURE dbo.sp_GhiNhatKy
...
-- 14) Thêm mô hình AI
CREATE OR ALTER PROCEDURE dbo.sp_ThemMoHinhAI
...
CREATE OR ALTER PROCEDURE dbo.sp_ThemPhienBanMoHinh
...
-- 16) Thêm dự đoán
CREATE OR ALTER PROCEDURE dbo.sp_ThemDuDoan
...
CREATE OR ALTER PROCEDURE dbo.sp_GetKhachHang
